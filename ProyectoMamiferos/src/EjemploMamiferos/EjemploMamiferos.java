package EjemploMamiferos;

import mamifero.Mamifero;
import mamifero.canino.Canino;
import mamifero.canino.Canino.*;
import mamifero.canino.Lobo;
import mamifero.canino.Lobo.*;
import mamifero.canino.Perro;
import mamifero.canino.Perro.*;
import mamifero.felinos.Felino;
import mamifero.felinos.Felino.*;
import mamifero.felinos.Guepardo;
import mamifero.felinos.Guepardo.*;
import mamifero.felinos.Leon;
import mamifero.felinos.Leon.*;
import mamifero.felinos.Tigre;
import mamifero.felinos.Tigre.*;
import mamifero.Mamifero.*;
